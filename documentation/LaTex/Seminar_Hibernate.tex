...
\input{subdoc/Projektmanagement}
\input{subdoc/Einarbeitung}
\input{subdoc/Anwendung}
%\input{subdoc/Kontextdiagramm}
%\input{subdoc/Prozesse}
%\input{subdoc/Disziplinen}
%\input{subdoc/IT_Rollen_und_Gremien}
%\input{subdoc/IT-Kernprozess}
%\input{subdoc/Plan_KVP}
\listoffigures
\nocite{*} 
